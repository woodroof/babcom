...
12. Если какие-то цепочки сработали в прошлый цикл, то создать новые.
13. В начале пятого цикла — проверить, купила ли в прошлом цикле организация [Тариель](babcom:org_tariel) лицензию у администрации за UN$1000.
